...
/* plugins directory. For multiple, use array format. */
$config['smarty_plugin_dir'][] = APPPATH .'third_party/smarty/customplugins/';

/* Cache directory. single */
$config['smarty_cache_dir'] = APPPATH .'cache';

/* Config directory. single */
$config['smarty_config_dir'] = APPPATH .'config';