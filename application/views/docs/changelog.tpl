<h1>Change Log</h1>
</p>This changelog considers the logo-generation tool.</p>
...
<ul>
<li>[BUG] Name of local only appears in 1 logo per download.</li>
</ul>
...
<h2>Version 1.x</h2>
<datetime>2013-10-08</datetime>
<p>First release of the logo generation tool.<p>